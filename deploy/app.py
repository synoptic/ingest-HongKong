...
# DEPLOYMENT
# BUILDX_NO_DEFAULT_ATTESTATIONS=1 cdk deploy HongKongObsLambda --profile ingest
# BUILDX_NO_DEFAULT_ATTESTATIONS=1 cdk deploy HongKongMetaLambda --profile ingest
